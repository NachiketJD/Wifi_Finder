...
#netsh command, which is used to get the list of available networks in the system. The wlan show network command is used to get the list of available networks in the system. The output of this command is stored in the nw object.
